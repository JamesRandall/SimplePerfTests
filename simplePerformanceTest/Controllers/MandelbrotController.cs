...
namespace simplePerformanceTest.Controllers
{
    public class MandelbrotController : Controller
    {
        ...
        [HttpGet("mandelbrot")]
        public IActionResult Render(double xMin = -2.1, double xMax = 0.9, double yMin = -1, double yMax = 1, int width=320, int height=200, int numberOfIterations=100)
        {
